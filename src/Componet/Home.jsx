    ...
    <>
      <div className="home fixed w-full h-full">
        <div className="container mx-auto items-center justify-center  h-screen">
          <h1 className="text-[45px] font-semibold text-center py-4 px-5">
            React Crude
          </h1>
          <div className="add flex justify-end px-5 py-5 ">
            <Link
              to="/create"
              className="bg-slate-500 p-2 text-white font-semibold w-28 text-center text-lg"
            >
              ADD +
            </Link>
          </div>
              ...
              {data.map((d, i) => (
                <tr key={i}>
                  ...
                  <td className="border-s-4">
                    <button className="px-5 bg-blue-400 text-white me-5 font-semibold p-1">
                      Read
                    </button>
                    <button className="px-5 bg-blue-600 text-white me-5 font-semibold p-1">
                      Edit
                    </button>
                    <button className="bg-red-600 text-white px-5 font-semibold p-1">
                      Delete
                    </button>
                  </td>
                </tr>
